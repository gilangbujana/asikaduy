...
public class DosenList extends ListActivity {
String ip="";
	...
	class load extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(DosenList.this);
		...
		protected String doInBackground(String... args) {
			...
			JSONObject json = jParser.makeHttpRequest(ip+"dosen/dosen_show.php", "GET", params);
			...
			try {
				...
				if (sukses == 1) {
					...
					for (int i = 0; i < myJSON.length(); i++) {
						...
						String nama_dosen = c.getString(TAG_nama_dosen);
						
						HashMap<String, String> map = new HashMap<String, String>();
							map.put(TAG_id_dosen, id_dosen);
							map.put(TAG_nama_dosen, nama_dosen);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(DosenList.this, arrayList,R.layout.desain_list, new String[] { TAG_id_dosen,TAG_nama_dosen,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});
